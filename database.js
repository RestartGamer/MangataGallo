...
articles = [
  {
    ...
    link: "link",
    price: "1200€",
    checkImages: ["media/ring-variant1.png", "media/rings-special2.png"],
...

  {
    ...
    link: "link",
    price: "1300€",
    checkImages: ["media/necklace-variant1.png", "media/necklace-highlight1.png"],
    checkImageSizes: ["100%", "100%"],
    checkImagePositions: ["center center", "center center"],
    checkVideo: "media/rings-hands-downscaled.mp4",
...

  {
    ...
    link: "link",
    price: "960€",
    checkImages: ["media/earrings-special1.png", "media/earrings-special2.png"],
    checkImageSizes: ["100%", "100%"],
    checkImagePositions: ["center center", "center center"],
    checkVideo: "media/rings-hands-downscaled.mp4",
    posterImage: ""
...

  {
    ...
    link: "link",
    price: "2560€",
    checkImages: ["media/watch-variant1.png", "media/watch-variant.jpg"],
    checkImageSizes: ["100%", "100%"],
    checkImagePositions: ["center center", "center center"],
    checkVideo: "media/rings-hands-downscaled.mp4",
    posterImage: ""
...
checkoutContent = [
  {
    ...
    promoLink: "product.html",
    promoArticleId: "A0002",
  }
];
